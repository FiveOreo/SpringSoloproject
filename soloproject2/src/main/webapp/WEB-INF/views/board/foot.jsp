				...
				<div class="col-sm-6">
					...
					<div class="row">
						<div class="col-md-12 hidden-xs text-right">
							<a href="https://www.instagram.com/s_m_lee93/"><i
								class="fa fa-4x fa-fw fa-instagram text-inverse"></i></a> <a
								href="https://facebook.com/leesm0331"><i
								class="fa fa-4x fa-facebook fa-fw text-inverse"></i></a> <a
								href="https://github.com/fiveOreo"><i
								class="fa fa-4x fa-fw fa-github text-inverse"></i></a>
						</div>
					</div>
				</div>
			</div>
